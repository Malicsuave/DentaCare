    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
		...
		<div class="slider-item" style="background-image: url('images/bg_1.jpg');">
			...
			<div class="row slider-text align-items-center" data-scrollax-parent="true">
				...
				<p class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"> Dentacare is here to make your dental journey a positive one, prioritizing comfort, convenience, and quality care tailored to your needs.</p>
				<p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="hms/user-login.php" class="btn btn-primary px-4 py-3">Make an Appointment</a></p>
				</div>
			</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="col-md-7 text-center heading-section ftco-animate">
				...
				<p>A warm touch that brightens your day, flowing like a gentle river through everything we do.</p>
			</div>
			</div>
			<div class="row">
			...
			<div class="row d-flex no-gutters">
				...
				<div class="col-md-6 d-flex">
					<div class="about-wrap">
						...
						<p>At our clinic, we prioritize the care and comfort of every patient, ensuring you receive a personalized treatment experience that’s tailored just for you.</p>
					</div>
						<div class="list-services d-flex ftco-animate">
							...
							<div class="text">
								...
								<p>Our skilled and compassionate dentist brings years of experience to provide the best dental care, helping you feel confident in your smile and your treatment.</p>
							</div>
						</div>
						<div class="list-services d-flex ftco-animate">
							<div class="icon d-flex justify-content-center align-items-center">
							...
							<div class="text">
								<h3>Comfortable and Relaxing Clinic</h3>
						...
						<div class="list-services d-flex ftco-animate">
							...
							<div class="text">
								<h3>Reliable and Affordable Care</h3>
								<p>You can count on us for affordable, reliable dental services that prioritize your comfort and well-being, ensuring that every visit is a positive experience.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="col-md-7 text-center heading-section ftco-animate">
				...
				<p>At DentaCare, we pride ourselves on having a skilled and compassionate dentist who brings years of experience to provide exceptional care. Our goal is to make every patient feel at ease while receiving personalized treatment, all in a comfortable, stress-free environment. Your smile is in good hands with us!</p>
			</div>
			</div>
			<div class="row">
		...
		<section class="ftco-section">
			...
			<div class="col-md-7 text-center heading-section ftco-animate">
				...
				<p> We believe everyone deserves a healthy, beautiful smile without breaking the bank. That’s why we offer affordable pricing with no hidden fees—just honest, transparent care. We’re here to support your dental health every step of the way, with the best value for your comfort and peace of mind.</p>
			</div>
			</div>
				<div class="row">
