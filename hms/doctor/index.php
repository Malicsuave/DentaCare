...
if (isset($_POST['submit'])) { // Check if form is submitted
    // Query to check if the email and password match a doctor in the database
    ...
    if ($num > 0) { // If credentials match
        ...
        // Insert successful login attempt into doctorslog
        ...
        header("location:http://$host$uri/$extra"); // Redirect to dashboard
        exit();
