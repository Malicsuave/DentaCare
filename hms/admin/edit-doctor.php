...
try {
    ...
    if (isset($_POST['submit'])) {
        ...
        $docaddress = sanitize_input($_POST['clinicaddress']);
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="docname" class="form-control" value="<?php echo sanitize_input($data['doctorName']);?>" >
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="clinicaddress" class="form-control"><?php echo sanitize_input($data['address']);?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="fess">
                                                            Doctor Fees
                                                        </label>
                                                        <input type="text" name="docfees" class="form-control" required="required" value="<?php echo sanitize_input($data['docFees']);?>" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="fess">
                                                            Doctor Contact no
                                                        </label>
                                                        <input type="text" name="doccontact" class="form-control" required="required" value="<?php echo sanitize_input($data['contactno']);?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="fess">
                                                            Doctor Email
                                                        </label>
                                                        <input type="email" name="docemail" class="form-control" readonly="readonly" value="<?php echo sanitize_input($data['docEmail']);?>">
                                                    </div>
                                                    <?php } ?>
