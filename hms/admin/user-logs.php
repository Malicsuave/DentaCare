                        ...
                        <div class="container-fluid container-fullw bg-white">
                                ...
                                <?php echo htmlentities($_SESSION['msg']="");?></p>	
                                    <table class="table table-hover" id="sample-table-1">
                                        ...
                                        <tbody>
<?php
// Fetch data from the userlogs table using prepared statements
...
?>
                            ...
                            <div class="row">
                            <div class="col-md-12">
                                <form action="user_pdf.php" method="post" style="display:inline;">
                                    <button type="submit" class="btn btn-danger">Export to PDF</button>
                                </form>
                                <form action="user_excel.php" method="post" style="display:inline;">
