                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-xs"><?php echo sanitize_input($row['PatientName']);?></td>
                                            <td><?php echo sanitize_input($row['PatientContno']);?></td>
                                            <td><?php echo sanitize_input($row['PatientGender']);?></td>
                                            <td><?php echo sanitize_input($row['CreationDate']);?></td>
                                            <td><?php echo sanitize_input($row['UpdationDate']);?></td>
                                            <td>
                                                <a href="view-patient.php?viewid=<?php echo sanitize_input($row['ID']);?>"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <?php 
                                            $cnt++;
