...
if(isset($_POST['submit']))
{
	...
	$query = mysqli_query($con, "INSERT INTO users(fullname, address, city, province, gender, email, password) VALUES('$fname', '$address', '$city','$province' ,'$gender', '$email', '$hashed_password')");
		...
		if($mail->send()) {
			...
			echo "<script>
				Swal.fire({
					icon: 'error',
					title: 'Oops...',
					text: 'Registration successful, but could not send email. Please contact support.',
				});
			</script>";
		}
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>DentaCare | Patient Registration</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
